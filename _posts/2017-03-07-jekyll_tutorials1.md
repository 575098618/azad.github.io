...
　使用 HEXO 在多台电脑上发布博客，操作起来并不是那么方便，果断就转到了 Jekyll 上，接下来我会讲如何使用 Jekyll 搭建博客，[博客模板效果](https://azadjun.github.io/#blog)。
...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如我的 github 账户名叫 [azadjun](https://github.com/azadjun)，我的 github 仓库名就叫 [azadjun.github.io](https://github.com/azadjun/azadjun.github.io)，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
　　编写一篇新文章很简单，你可以直接从 _posts/ 目录下复制一份出来 `2017-3-7-welcome-to-jekyll副本.markdown` ，修改名字为 2017-3-7-article1.markdown ，注意：文章名的格式前面必须为 2017-3-7- ，日期可以修改，但必须为 年-月-日- 格式，后面的 article1 是整个文章的连接 URL，如果文章名为中文，那么文章的连接URL就会变成这样的：http://azadjun.github.io/2017/03/%E6%90%AD%E5/ ， 所以建议文章名最好是英文的或者阿拉伯数字。 双击 2017-3-7-article1.markdown 打开
...
date:  显示的文章发布日期，如：date: 2017-3-7                          
...
首先你要获取的我博客，[Github项目地址](https://github.com/azadjun/azadjun.github.io.git)，你可以直接[点击下载博客](https://github.com/azadjun/azadjun.github.io/archive/master.zip)，进去azadjun.github.io/ 目录下， 使用命令部署本地服务 
...
```
Configuration file: /Users/tendcloud-Caroline/Desktop/azadjun.github.io/_config.yml
...
```
Configuration file: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/azadjun.github.io-github/_config.yml
            Source: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/azadjun.github.io-github
       Destination: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/azadjun.github.io-github/_site
 Incremental build: disabled. Enable with --incremental
      Generating... 
                    done in 0.901 seconds.
 Auto-regeneration: enabled for '/Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/azadjun.github.io-github'
Configuration file: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/azadjun.github.io-github/_config.yml
...
在浏览器输入 [127.0.0.1:4000](127.0.0.1:4000) ， 就可以看到[azadjun.github.io](http://azadjun.github.io)博客效果了。
...
如果你在搭建博客遇到问题，可以在[原文博客](http://azadjun.github.io/2017/3/jekyll_tutorials1/)的评论里给我提问。
